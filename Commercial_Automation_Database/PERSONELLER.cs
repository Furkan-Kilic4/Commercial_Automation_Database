...
namespace Commercial_Automation_Database
{
    public partial class PERSONELLER : Form
    {
        ...
        private void BTNKAYDET_Click(object sender, EventArgs e)
        {
            ...
            string sorgu = "insert into TBL_PERSONEL (AD,SOYAD,TC,TELEFON,MAİL,İL,İLÇE,ADRES,GÖREVİ) values (@P1,@P2,@P3,@P4,@P5,@P6,@P7,@P8,@P9)";
            ...
            cm.Parameters.AddWithValue("@P9", TXTGOREV.Text);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            TXTGOREV.Text = dataGridView1.CurrentRow.Cells[9].Value.ToString();
        }
        ...
        private void BTNSIL_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand komut = new SqlCommand("select * from TBL_PERSONEL where ID ='" + TXTID.Text + "'", bgl.baglanti());
                komut.ExecuteNonQuery();
                SqlDataReader dr = komut.ExecuteReader();
                if (dr.Read())
                {
                    SqlCommand cm = new SqlCommand("delete from TBL_PERSONEL where ID ='" + TXTID.Text + "'", bgl.baglanti());
                    int basari = cm.ExecuteNonQuery();
                    bgl.baglanti().Close();
                    if (basari == 1)
                    {
                        MessageBox.Show("KAYITLI PERSONEL SİLİNDİ", "UYARI", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
                        MessageBox.Show("KAYITLI PERSONEL SİLİNMEDİ", "UYARI", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                }
